package com.test.coding.baekjoon.sort;
 ...
 *
 * $_1920 의 설명
 * 패키지: com.test.coding.baekjoon.sort
 * 알고리즘 분류: 구현
    ...
    public static void main(String[] args) {
        try(BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
            ...
            for(int l = 0; l < b.length; i++){
                ...
                bw.write(binarySearch(a, 0, a.length - 1, b[l]) + "\n");
            }
